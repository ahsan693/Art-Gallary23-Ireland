...
export default function Header() {
  ...
  return (
    <header className={`relative z-50 flex w-full flex-col items-center border-b border-border bg-white ${["/checkout-papersize", "/checkout-details"].includes(pathname) ? "max-md:hidden" : ""}`}>
