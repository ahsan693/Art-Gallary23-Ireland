...
const getSocialIcon = (label: string) => {
  ...
  if (lower.includes("instagram") || lower === "ig") {
    return (
      <svg className="size-[22px] text-forest-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return <span className="body-small font-bold text-forest-green">{label}</span>;
};
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <div className="flex gap-[16px]">
                {data.contactInfo.socials.map((social: any, i: number) => (
                  <Link key={i} href={social.url} className="flex size-[48px] items-center justify-center rounded-full border border-[#D5D5D5] bg-white transition hover:bg-warm-cream">
